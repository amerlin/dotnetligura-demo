...
const teamMembers = [
	{
		...
		title: 'Presidente',
		image: '/src/assets/raffaele_rialdi.png',
		description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
	},
	{
		name: 'Giampaolo Tucci',
		title: 'Vice Presidente',
		image: '/src/assets/giampaolo_tucci.png',
		description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
	},
	{
		name: 'Andrea Belloni',
	...
	},
	{
		name: "Andrea Merlin",
		title: '',
		image: '/src/assets/andrea_merlin.png',
		description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
	},
	{
		name: "Lorenzo Billi",
		title: '',
		image: '/src/assets/lorenzo_billi.png',
		description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
	},
	{
		name: "Diego Zunino",
		title: '',
		image: '/src/assets/diego_zunino.png',
		description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
	}
];
			...
			<main className="home-container">
				<section className="hero fullscreen-section first" id="home">
					<div className="section-content">
						<img src="/src/assets/logo-default.png" alt="DotNet Liguria Logo" className="logo" />
						<p className="subtitle">La prima community .NET della Liguria</p>
					</div>
				</section>
				...
				<section className="dotnet-conf fullscreen-section" id="dotnet-conf">
					<Container maxWidth={false} className="section-content" style={{ padding: '0 4rem', paddingTop: '30px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
						...
						<Box sx={{ marginBottom: 3 }}>
							<img src="/src/assets/Locandina Evento Dicembre 2025.png" alt="Locandina Evento .NET Conf 2025" style={{ maxWidth: '100%', height: 'auto', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }} />
						</Box>
